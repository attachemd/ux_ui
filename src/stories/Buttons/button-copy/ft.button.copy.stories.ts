import {FtButtonCopyComponent} from './ft.button.copy.component';
import type {Meta, StoryObj} from '@storybook/angular';

const meta: Meta<FtButtonCopyComponent> = {
  title: 'Buttons/Button Copy',
  component: FtButtonCopyComponent,
  tags: ['autodocs'],
  argTypes: {
    prefixIconClass: {
      control: 'select',
...
export default meta;
type Story = StoryObj<FtButtonCopyComponent>;
